...
import com.summer.whm.common.utils.BeanPropertyUtils;
import com.summer.whm.common.utils.JdbcUtils;

/**
 * Mybatis的分页查询插件，通过拦截StatementHandler的prepare方法来实现。 只有在参数列表中包括PageModel类型的参数时才进行分页查询。 在多参数的情况下，只对第一个PageModel类型的参数生效。
 * 
 * @author zhou
 * 
 */
