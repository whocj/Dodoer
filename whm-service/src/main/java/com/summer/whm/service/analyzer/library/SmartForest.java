package com.summer.whm.service.analyzer.library;
...
public class SmartForest<T> implements Comparable<SmartForest<T>> {
    ...
    private SmartForest<T> add(SmartForest<T> branch) {
        ...
        if (bs < 0) {
            ...
            if (branches != null && branches.length >= MAX_SIZE * rate) {
                ...
                System.arraycopy(branches, insert, newBranches, insert + 1, branches.length
                                                                            - insert);
    ...
    public static void main(String[] args) {
        ...
        SmartForest<Integer> branch2 = sf.getBranch("1");
