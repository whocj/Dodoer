...
public class ShellCommand extends SysCommand {
    ...
    public ShellCommand(String string, CommandContext context) throws CommandException {
        super();
    ...
    public static void main(String[] args) {
        ...
        List<String> list = command.exec("cmd /c netstat -ano");
