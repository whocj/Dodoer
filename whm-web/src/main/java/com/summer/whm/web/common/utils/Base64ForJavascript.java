...
public class Base64ForJavascript {
    ...
    public static void main(String[] args) throws Exception {
        String data = "e2NoYXRrZXk6ZjE5OTBlNjdmMmRjMmFmNDBhYmRlYjAwOGFmNWRlM2JmcmllbmROYW1lOmNoZW5qaW50eXBlOlVzZXJ1c2VybmFtZTphZG1pbmNvbnRlbnQ6cXFxfQ==";
        //aHR0cDovL2xvY2FsaG9zdDo3MDAxL3dobS1hc2std2ViL2luZGV4Lmh0bQ==
        String data1 = encode(data);
        String data2 = decode(data);
