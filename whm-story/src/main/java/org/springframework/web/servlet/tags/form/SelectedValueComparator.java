 ...
 * @since 2.0
 * @author Johnny 由于exhaustiveCompare特别慢，会造成行性能问题，不采用
 */
...
//		}
	...
	private static boolean collectionCompare(Collection boundCollection, Object candidateValue, BindStatus bindStatus) {
		...
		return false; //exhaustiveCollectionCompare(boundCollection, candidateValue, bindStatus);
	}
	...
	private static boolean mapCompare(Map boundMap, Object candidateValue, BindStatus bindStatus) {
		...
		return false;//exhaustiveCollectionCompare(boundMap.keySet(), candidateValue, bindStatus);
	}
