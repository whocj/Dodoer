...
public class RunScript {
    ...
    public static void main(String[] args) throws FailingHttpStatusCodeException, Exception {
        ...
        InputStream is = RunScript.class.getResourceAsStream("detail_title.script");
        ...
        htmlPage = webClientPool.borrowWebClient().getPage("http://www.d8qu.com/html/1/1677/174301.html");
