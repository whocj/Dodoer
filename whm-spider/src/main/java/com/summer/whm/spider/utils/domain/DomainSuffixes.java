...
package com.summer.whm.spider.utils.domain;

import java.util.HashMap;

/**
 * Storage class for <code>DomainSuffix</code> objects Note: this class is singleton
 * 
...
public class DomainSuffixes {
    ...
    /**
     * Return the {@link DomainSuffix} object for the extension, if extension is a top level domain returned object will
     * be an instance of {@link TopLevelDomain}
     * 
