...
public class ChuanyuemiSpider {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] urls = new String[] { "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=1",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=2",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=3",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=4",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=5",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=6",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=7",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=8",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=9",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=10",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=11",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=12",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=13",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=14",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=15",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=16",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=17",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=18",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=19",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=10",
                "http://www.chuanyuemi.com/booklist.asp?id=7&pageid=21"
            ...
            if (anchorList != null && anchorList.size() > 0) {
                ...
                for (HtmlAnchor htmlAnchor : anchorList) {
                    ...
                    if (href != null) {
                        ...
                        if (categoryId != null) {
                            seedList.add(new StorySeed(htmlAnchor.getTextContent(), categoryId + "", "28", "http://www.chuanyuemi.com" + href,
                                    "* 1 2 * * * *"));
                        }
                    }
                }
