package com.summer.whm.spider.script.qbxs8;
...
public class StoryNextAnchor implements IBshScript {
    ...
    public static void main(String[] args) throws FailingHttpStatusCodeException, MalformedURLException, IOException, Exception {
        ...
        htmlPage = webClientPool.borrowWebClient().getPage("http://www.qbxs8.net/book.asp?id=6635");
        
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
        map.put("htmlPage", htmlPage);
        
       List<HtmlAnchor> nextAnchorList = (List<HtmlAnchor>) htmlPage.getByXPath("//div[@class='blink']/a[1]");
