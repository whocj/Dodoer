...
public class StringUtils {
    ...
    public static enum TraditionalBinaryPrefix {
        KILO(10), MEGA(KILO.bitShift + 10), GIGA(MEGA.bitShift + 10), TERA(GIGA.bitShift + 10), PETA(TERA.bitShift + 10), EXA(
                PETA.bitShift + 10);
     ...
     * the result. The regular expression must use a capturing group. The value of the first capturing group is used to
     * look up the replacement. If no replacement is found for the token, then it is replaced with the empty string.
     * 
    ...
    /**
     * Returns a copy of <code>s</code> padded with trailing spaces so that it's length is <code>length</code>. Strings
    ...
    /**
     * Returns a copy of <code>s</code> padded with leading spaces so that it's length is <code>length</code>. Strings
     * already <code>length</code> characters long or longer are not altered.
     */
